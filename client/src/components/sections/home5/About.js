                        ...
                        <div className="about-four__left">
                            ...
                            <div className="about-four-img">
                                ...
                                <div className="about-four-video">
                                    <a className="video-popup" title="Video Gallery" onClick={() => setOpen(true)}>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-xl-4 col-lg-4">
                                        <div className="about-four__right-counter-single text-center">
                                            ...
                                            <div className="count-box count-box">
                                                <h2 className="count-text" data-stop="250" data-speed="1500">00</h2>
                                                <span>k</span>
                                            </div>
                                    ...
                                    <div className="col-xl-4 col-lg-4">
                                        <div className="about-four__right-counter-single text-center">
                                            ...
                                            <div className="count-box count-box">
                                                <h2 className="count-text" data-stop="20" data-speed="1500">00</h2>
                                                <span>bil</span>
                                            </div>
                                            <div className="title-box">
                                    ...
                                    <div className="col-xl-4 col-lg-4">
                                        <div className="about-four__right-counter-single text-center">
                                            ...
                                            <div className="count-box count-box">
                                                <h2 className="count-text" data-stop="90" data-speed="1500">00</h2>
